<?php
namespace app\widgets\crud\generators;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerClass', 'modelClass', 'searchModelClass', 'baseControllerClass','title'], 'filter', 'filter' => 'trim'],
    ...
    public function getExportColumns(){
        $columns = [];
        foreach ($this->getColumnNames() as $i => $column) {
            $columns[$i] = "'" . $column . "',";
        }
        return $columns;
    }
