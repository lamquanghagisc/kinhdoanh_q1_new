...
/* @var $searchModel app\modules\quanly\models\ThongtinViphamSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Thông tin vi phạm';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="thongtin-vipham-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Thông tin vi phạm','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
