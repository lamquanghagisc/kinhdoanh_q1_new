...
namespace app\modules\contrib\gii\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerClass', 'modelClass', 'searchModelClass', 'baseControllerClass', 'modelName'], 'filter', 'filter' => 'trim'],
            [['modelClass',  'baseControllerClass', 'indexWidgetType', 'modelName'], 'required'],
    ...
    public function validateModelClass()
    {
        ...
        $this->controllerClass = str_replace("models", "controllers", $this->modelClass) . 'Controller';
        $pos = strrpos($this->controllerClass, '\\');
        $controllerClassName = substr(substr($this->controllerClass, $pos + 1), 0, -10);
        $controllerId = Inflector::camel2id(
            $controllerClassName,
            '-',
            $this->strictInflector
        );
        $this->viewPath  = str_replace("models", "views", $this->modelClass);
        $this->viewPath = "@" . str_replace($controllerClassName, $controllerId, $this->viewPath);
    }
