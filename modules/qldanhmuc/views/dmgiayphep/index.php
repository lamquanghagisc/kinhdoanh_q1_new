...
/* @var $searchModel app\modules\quanly\models\DmGiayphepSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Danh mục giấy phép';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="dm-giayphep-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Danh mục giấy phép','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
